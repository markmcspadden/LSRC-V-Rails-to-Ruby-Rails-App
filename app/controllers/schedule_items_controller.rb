  ...
  def create
    ...
    respond_to do |format|
      if @schedule_item.save
        format.html { redirect_to(@schedule_item, :notice => 'Schedule item level was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @schedule_item.update_attributes(params[:schedule_item])
        format.html { redirect_to(@schedule_item, :notice => 'Schedule item level was successfully updated.') }
        format.xml  { head :ok }
      else
